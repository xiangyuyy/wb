...
public class HttpHelper {
    ...
    private static String entityToString(HttpEntity entity) throws IOException {
        ...
        if(entity != null)
        {
            long lenth = ((org.apache.http.HttpEntity) entity).getContentLength();
            if(lenth != -1 && lenth < 2048)
            {
                result = EntityUtils.toString((org.apache.http.HttpEntity) entity,"UTF-8");
            }else {
                InputStreamReader reader1 = new InputStreamReader(((org.apache.http.HttpEntity) entity).getContent(), "UTF-8");
