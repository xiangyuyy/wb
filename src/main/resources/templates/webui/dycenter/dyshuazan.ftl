		...
		<div class="layui-card">
			<div class="layui-card-body" style="padding: 15px;">
				...
				<form class="layui-form" action="" lay-filter="component-form-group">
					...
					<div class="layui-form-item">
						<label class="layui-form-label">抖音地址<span class="need">*</span></label>
						<div class="layui-input-inline cz">
							<input type="text" name="orderurl" value="" maxlength="100"
								lay-verify="required" placeholder="" autocomplete="off"
								class="layui-input">
						</div>
						<div class="layui-form-mid layui-word-aux">获取抖音视频地址方法：点击视频中的分享按钮，右滑底部至复制链接，粘贴链接后获取内容中的URL http://v.douyin.com/dKm8hH/</div>
