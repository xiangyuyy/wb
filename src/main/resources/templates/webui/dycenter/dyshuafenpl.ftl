...
.need {
	...
	<div class="layui-fluid">
			...
			<div class="layui-card-body" style="padding: 15px;">
				...
				<form class="layui-form" action="" lay-filter="component-form-group">
					...
					<div class="layui-form-item" id="rsd">
						<label class="layui-form-label">抖音地址,数量<span class="need">*</span></label>
        ...
        <textarea name="url" lay-verify="required" placeholder=""  style="width: 400px; height: 150px;" autocomplete="off" class="layui-textarea"></textarea>
						...
						<div class="layui-form-mid layui-word-aux"><span>格式为：抖音地址,刷粉数量</span></br>
<span>http://v.douyin.com/dKm8hH/,1000</span></br>
<span>http://v.douyin.com/dKm8hH/,2000</span></div>
					</div>								
					<div class="layui-form-item">
