    ...
    <div class="layui-form-item">
      ...
      <div class="layui-input-inline">
        <input type="text" name="thirdfastprice" value="${order.allok!}" lay-verify="required|littlenumber"  autocomplete="off" class="layui-input">
                           ...
                           <div class="layui-form-item">
      <label class="layui-form-label">刷赞总数</label>
      <div class="layui-input-inline">
...
<#else>
      ...
      <div class="layui-input-inline"> 
        <input type="text" name="createtime" value="${(order.createtime?string('yyyy-MM-dd hh:mm:ss'))!}" lay-verify="" autocomplete="off" class="layui-input">
      </div>
    </div>
                            <div class="layui-form-item">
