...
<!-- 					<div class="layui-inline">
						...
						<div class="layui-input-inline">
							<select name="isfast" lay-verify="required">
								<option value=""></option>
...
{{# }}}
 <a class="layui-btn layui-btn-normal layui-btn-xs" lay-event="infor">详情</a>
  ...
  layui.config({
  ...
  }).use(['index', 'wbhuatgzlist', 'table'], function(){
    ...
    layer.open({
        type: 2
        ,title: '添加'
        ,content: "/cgcenter/wbhuatgz?id="+${goodid!}
        ,maxmin: false
        ,area: ['90%', '90%']
      }); 
    }
    var $ = layui.$, active = {
      ...
      add: function(){
        ...
        layer.open({
          type: 2
          ,title: '添加'
          ,content: '/cgcenter/wbhuatgz?id='+id
          ,maxmin: false
          ,area: ['90%', '90%']
        }); 
      },
