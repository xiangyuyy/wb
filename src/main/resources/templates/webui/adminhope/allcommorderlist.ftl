				...
				<div class="layui-form-item">
						...
						<div class="layui-input-inline">
							<input type="text" name="bycustomerid" placeholder="下单人卡号"
								...
								<div class="layui-inline">
						<label class="layui-form-label">受益人人卡号</label>
						<div class="layui-input-inline">
							<input
								type="text" name="forgoodcustomerid" placeholder="受益人人卡号" autocomplete="off"
								class="layui-input">
						</div>
					</div>
													<div class="layui-inline">
						<label class="layui-form-label">中间人卡号</label>
						<div class="layui-input-inline">
							<input
								type="text" name="onecustomerid" placeholder="中间人卡号" autocomplete="off"
								class="layui-input">
						</div>
					</div>
										<div class="layui-inline">
						...
						<div class="layui-input-inline">
							<input
								...
								class="layui-input">
									...
									<div class="layui-inline">
						<label class="layui-form-label">返佣列表</label>
						<div class="layui-input-inline">
...
{{# }}}
 <a class="layui-btn layui-btn-normal layui-btn-xs" lay-event="infor">详情</a>
  ...
  }).use(['index', 'allcommorderlist', 'table'], function(){
