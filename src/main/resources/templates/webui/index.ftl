			...
			<div class="layui-header">
				...
				<ul class="layui-nav layui-layout-left">
					...
					<li class="layui-nav-item layui-hide-xs" lay-unselect><a
						href="/first" target="_blank" title="前台">
					...
					<ul class="layui-nav layui-nav-tree" lay-shrink="all"
						...
						<li data-name="home" class="layui-nav-item layui-nav-itemed">
							<a href="javascript:;" lay-tips="主页" lay-direction="2"> <i
								class="layui-icon layui-icon-home"></i> <cite>个人中心</cite>
						</a>
							<dl class="layui-nav-child">
								...
								<dd>
									<a lay-href="/customerinfor">账号信息</a>
								</dd>
							</dl>
						</li>
						<li data-name="component" class="layui-nav-item"><a
							href="javascript:;" lay-tips="下单中心" lay-direction="2"> <i
								class="layui-icon layui-icon-component"></i> <cite>下单中心</cite>
						</a>
							<dl class="layui-nav-child">
								<#list goodCenerVos as goodtype>
								<dd data-name="content">
									<a href="javascript:;">${goodtype.goodtypename}</a>
									<dl class="layui-nav-child">
										<#list goodtype.goodclasses as goodclass>
									<dd data-name="content">
									<a href="javascript:;">${goodclass.goodclassname}</a>
									<dl class="layui-nav-child">
										<#list goodclass.goods as good>
										<dd data-name="${good.id}">
											<a lay-href="${good.hopeurl!}?goodid=${good.id}">${good.goodname}</a>
										</dd></#list>
									</dl>
								</dd>
									</#list>
						...
						<li data-name="template" class="layui-nav-item"><a
							href="javascript:;" lay-tips="页面" lay-direction="2"> <i
								class="layui-icon layui-icon-template"></i> <cite>订单中心</cite>
						</a>
							<dl class="layui-nav-child">
								<dd>
									<a lay-href="/showorder/orderlist">订单列表</a>
								</dd>
								<dd>
									<a lay-href="/showorder/addbalancelist">充值列表</a>
								</dd>
																<dd>
									<a lay-href="/showorder/onecommcustomerlist">代理列表</a>
								</dd>
											<dd>
									<a lay-href="/showorder/onecommorderlist">一级返佣列表</a>
								</dd>
																	<dd>
									<a lay-href="/showorder/twocommorderlist">二级返佣列表</a>
								</dd>
								<dd>
									<a lay-href="/showorder/balancerecordlist">余额变更详情</a>
								</dd>
							</dl></li>
						<li data-name="component" class="layui-nav-item"><a
							href="javascript:;" lay-tips="商品管理" lay-direction="2"> <i
								class="layui-icon layui-icon-component"></i> <cite>商品管理</cite>
						</a>
							<dl class="layui-nav-child">
								<dd>
						...
						<li data-name="app" class="layui-nav-item"><a
							href="javascript:;" lay-tips="统计系统" lay-direction="2"> <i
								class="layui-icon layui-icon-app"></i> <cite>统计系统</cite>
						</a>
							<dl class="layui-nav-child">
										<dd>
									<a lay-href="/adminhope/allcustomerlist">用户统计</a>
								</dd>
																	<dd>
									<a lay-href="/adminhope/allonecommcustomerlist">用户代理统计</a>
								</dd>
								<dd>
									<a lay-href="/adminhope/allorderlist">订单统计</a>
								</dd>
								<dd>
									<a lay-href="/adminhope/alladdbalancelist">充值统计</a>
								</dd>
								<dd>
									<a lay-href="/adminhope/allbalancerecordlist">用户余额变更统计</a>
								</dd>
								</dd>
								<dd>
									<a lay-href="/adminhope/allcommorderlist">返佣统计</a>
								</dd>
								<dd>
									<a lay-href="/adminhope/admindealhopelist">管理员余额处理列表</a>
								</dd>
							</dl></li>
