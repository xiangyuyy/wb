			...
			<div class="layui-card-body" style="padding: 15px;">
				...
				<form class="layui-form" action="" lay-filter="component-form-group">
					...
					<div class="layui-form-item">
						...
						<input name="orderusername" id="orderusername" value="" hidden>		
						<input name="positionstart" id="positionstart" value="" hidden>	
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-inline cz">
							<input type="text" name="kind" value="2"  hidden>
					...
					<label class="layui-form-label"></label>
						...
						<div class="layui-form-item" id="rid" >
						<label class="layui-form-label">评论rid <span class="need">*</span></label>
						<div class="layui-input-inline cs">
							<input type="text" name="mid" value="" maxlength="100"
								lay-verify="required" placeholder="评论rid" autocomplete="off"
								class="layui-input">
						</div>
						 <div class="layui-form-mid layui-word-aux">使用谷歌浏览器找到要刷的评论，点击投诉，在弹出的页面地址中复制并提交rid后面的数字。</div>
					</div>
								
					<div class="layui-form-item">
						<label class="layui-form-label">数量<span class="need">*</span></label>
						<div class="layui-input-inline cz">
							<input type="text" name="allnum" value="100" maxlength="10000"
  ...
  layui.config({
    ...
    $("input[name='orderurl']").blur(function(){
      ...
      if(res.sucess){
           ...
           $("#pnum").text(num);
           $("#orderusername").val(wbname);
           $("#positionstart").val(num);
           righturl = 1;
    }
     else{
    	 righturl = 0
